...
typedef enum
{
  ...
  TM_CHFDIV_2   = 0x00000010,     /*!< TM channel Filter Fsampling = Fdts/2                                 */
  TM_CHFDIV_4   = 0x00000020,     /*!< TM channel Filter Fsampling = Fdts/4                                 */
  TM_CHFDIV_8   = 0x00000030,     /*!< TM channel Filter Fsampling = Fdts/8                                 */
  TM_CHFDIV_16  = 0x00000040,     /*!< TM channel Filter Fsampling = Fdts/16                                */
  TM_CHFDIV_32  = 0x00000050,     /*!< TM channel Filter Fsampling = Fdts/32                                */
  TM_CHFDIV_64  = 0x00000060      /*!< TM channel Filter Fsampling = Fdts/64                                */
} TM_CHFDIV_Enum;
/**
...
typedef struct
{
  ...
  TM_CHFEV_Enum   Event;         /*!< Digital filter N-event counter Setting, it must 0, 2,4, 8,12, 16      */
  #endif
 ...
 */
#define IS_TM_INT(x) (((x & 0xFFFFFAF0) == 0x0) && (x != 0))
/**
