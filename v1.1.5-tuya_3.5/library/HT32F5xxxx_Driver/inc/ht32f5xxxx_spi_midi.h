...
{
  u16 MIDICTRL_MODE;
  u16 MIDICTRL_CommandLength;
  u16 MIDICTRL_AddressLength;
  u16 MIDICTRL_ModeLength;
  u16 MIDICTRL_DummyLength;
  u16 MIDICTRL_DataLength;
  u16 MIDICTRL_CommandValue;
  u16 MIDICTRL_ModeValue;
