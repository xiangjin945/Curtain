...
#if (!LIBCFG_NO_FMC_WAIT_STATUS)
/*********************************************************************************************************//**
 * @brief Configure the FLASH wait state.配置FLASH等待状态
...
/*********************************************************************************************************//**
 * @brief Enable or Disable FLASH pre-fetch buffer.启用或禁用FLASH预取缓冲区。
...
/*********************************************************************************************************//**
 * @brief Set vector remapping mode.设置向量重映射模式。
...
/*********************************************************************************************************//**
 * @brief Erase a specific FLASH page.擦除特定的FLASH页面
...
/*********************************************************************************************************//**
 * @brief Erase FLASH Option Byte page.擦除闪存选项字节页面。
 * @retval FLASH_State
 *   - \ref FLASH_COMPLETE
 *   - \ref FLASH_TIME_OUT
 *   - \ref FLASH_ERR_WRITE_PROTECTED
...
/*********************************************************************************************************//**
 * @brief Erase the entire FLASH.擦除整个闪存。
 * @retval FLASH_State
 *   - \ref FLASH_COMPLETE
 *   - \ref FLASH_TIME_OUT
 * @note  HSI must keep turn on when doing the Flash operation (Erase/Program).
...
/*********************************************************************************************************//**
 * @brief Program one word data.编程一个字数据。
...
/*********************************************************************************************************//**
 * @brief Program FLASH Option Byte page.程序闪存选项字节页面。
...
/*********************************************************************************************************//**
 * @brief Return security status of the FLASH.返回FLASH的安全状态。
 * @param Option: Struct pointer of Option Bytes.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Enable or Disable the specific FLASH interrupts.启用或禁用特定的FLASH中断。
...
/*********************************************************************************************************//**
 * @brief Return flag status of the FLASH interrupt.FLASH中断的返回标志状态。
...
/*********************************************************************************************************//**
 * @brief Wait untill the FLASH operation has finished or time-out has occurred.等到FLASH操作完成或发生超时。
 * @retval FLASH_State
 *   - \ref FLASH_COMPLETE
 *   - \ref FLASH_TIME_OUT
 *   - \ref FLASH_ERR_WRITE_PROTECTED
