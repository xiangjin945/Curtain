...
SYSTEM_EXTERN unsigned char Production_test_uart_rx_buf[256];
//
SYSTEM_EXTERN volatile unsigned char *queue_in;
SYSTEM_EXTERN volatile unsigned char *queue_out;

SYSTEM_EXTERN volatile unsigned char *test_queue_in;//产测用
SYSTEM_EXTERN volatile unsigned char *test_queue_out;
