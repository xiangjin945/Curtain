...
#define	    APP_NEW_FW_START_ADR	            0x7000
#define     APP_NEW_FW_END_FLAG	                0xD000
#define	    APP_NEW_FW_END_ADR	                (0x61000-1)

#define 	APP_NEW_FW_SETTING_ADR				(1024 * 58)
#define     APP_UPDATA_INFO_REASED              (APP_NEW_FW_SETTING_ADR + 2048)
#define	    APP_NEW_FW_MAX_SIZE                (APP_NEW_FW_END_ADR - APP_NEW_FW_START_ADR)//116K

#define     UPDATA_SIZE	                        200
#pragma anon_unions
typedef struct
{
