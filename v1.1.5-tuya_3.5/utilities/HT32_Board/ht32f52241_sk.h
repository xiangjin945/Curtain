...
#define COM0_CLK(CK)                (CK.Bit.UART0)
#define COM_TYBN1                   (HT_UART0)
#define COM0_IRQn                   (UART0_IRQn)
#define COM0_IRQHandler             (UART0_IRQHandler)

#define COM0_TX_GPIO_ID             (GPIO_PB)
#define COM0_TX_AFIO_PIN            (AFIO_PIN_7)
#define COM0_TX_AFIO_MODE           (AFIO_FUN_USART_UART)

#define COM0_RX_GPIO_ID             (GPIO_PB)
#define COM0_RX_AFIO_PIN            (AFIO_PIN_8)
